...
| Ridge | Created | `#mark-ridge` symbol; `assets/ridge.svg` | Two-peak mountain ridge drawn as a graffiti marker stroke, with a drip and spray dots, on a rough marker ground bar; replaces the crown (20 September). Placements: header wordmark, hero poster, campaign card. The photographs still show the crown. |
