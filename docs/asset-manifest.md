...
| Peaks | Created | `#mark-peaks` symbol; `assets/peaks.svg` | Two-peak mountain as a dry-brush stroke in the wordmark’s manner (frayed ends, ragged edges, flecks) with a sweep beneath; generated by `tools/brush-mark.py`, replacing the crown (20 September). Placements: header wordmark, hero poster, campaign card. The photographs still show the crown. |
