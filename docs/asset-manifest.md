...
| Ridge | Created | `#mark-ridge` symbol; `assets/ridge.svg` | Three-peak mountain ridge on a ground line, replacing the crown (20 September). Placements: header wordmark, hero poster, campaign card. The photographs still show the crown. |
